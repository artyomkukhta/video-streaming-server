...
public class LocalStorageService {
    ...
    public static File concatenateVideos(String outputPath, String... videoPaths) throws IOException, InterruptedException {
        // Output file path
        File outputFile = new File(outputPath);

        // Form FFmpeg command to concatenate videos
        ProcessBuilder pb = new ProcessBuilder("ffmpeg", "-i", "concat:" + String.join("|", videoPaths), "-c", "copy", outputFile.getAbsolutePath());
        ...
        if (outputFile.exists()) {
            ...
            throw new IOException("Failed to concatenate videos");
        }
    }
